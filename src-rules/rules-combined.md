...
Beach volley on kaikilla mittareilla yksi maailman menestyneimmistä ja suosituimmista urheilulajeista. Sillä on valtavat TV-katsojaluvut ja sosiaalisen median seuraajamäärät, sekä suurempi (ja yhä kasvava) rekisteröityjen ja harrastepelaajien määrä kuin lähes millään muulla lajilla. Lajin imago on dynaaminen, puhdas ja värikäs, ja se tarjoaa erityisesti kilpatasolla visuaalisen ja äänellisen elämyksen, joka viihdyttää kaikkia.

Yksinkertaisesti sanottuna laji on nopea, jännittävä ja toiminta on räjähtävää. Lentopallon beach-muoto sisältää kuitenkin useita ratkaisevia, toisiinsa limittyviä elementtejä, joiden toisiaan täydentävä vuorovaikutus tekee siitä ainutlaatuisen verkkopelien joukossa ja luo erityisen viehätyksen, joka erottaa sen muista lajin muodoista.

## BEACH VOLLEY ON KILPAURHEILUA

Kilpailu tuo esiin parhaat puolet. Se on näyteikkuna taidolle, hengelle, luovuudelle ja estetiikalle. Säännöt on laadittu niin, että kaikki nämä ominaisuudet pääsevät oikeuksiinsa. Lajin pioneerit Kalifornian hiekalla tunnistaisivat pelin edelleen. Viime vuosina FIVB on kuitenkin ottanut merkittäviä edistysaskelia mukauttaakseen peliä nykyaikaiseksi yleisölajiksi.

Tässä suhteessa beach volley on säilyttänyt tietyt erottuvat ja olennaiset elementit vuosien varrella. Joitakin näistä se jakaa muiden verkko-/pallo-/mailapelien kanssa:
- Aloitus (syöttö)
- Kierto (vuorotellen syöttäminen)
- Hyökkäys
- Puolustus
- Pelaajat voivat pelata missä tahansa kentällä.

Mutta urheilu on mennyt eteenpäin. Tänään se on räjähtävämpää ja näyttävämpää. Se on nopeaa ja vapaasti virtaavaa; siinä on urheilullisia pelaajia tekemässä sensaatiomaisia suorituksia täysien katsomoiden edessä. Lisäksi beach volley on ainutlaatuinen verkkopelien joukossa vaatiessaan, että pallo on jatkuvassa lennossa – *lentävä pallo* – ja sallimalla kummallekin joukkueelle tietyn määrän sisäistä syöttelyä ennen kuin pallo on palautettava vastustajalle. Tämä luo pallon jakamisen kulttuurin, joka tuottaa tasavertaisia pistemahdollisuuksia.

Viime vuosina FIVB on tehnyt massiivisia investointeja teknologian käyttöön. Video Challenge System -järjestelmä tuo oikeudenmukaisuutta urheilijoiden ponnisteluille ja rohkaisee filosofioita, jotka edistävät virtaavaa peliä yleisön viihdyttämiseksi sekä paikan päällä että ruudun ääressä.

Kilpailijat käyttävät tätä viitekehystä kilpaillakseen tekniikalla, taktiikalla ja voimalla. Viitekehys antaa pelaajille myös ilmaisunvapauden innostaa katsojia ja luoda vertaansa vailla olevan urheilunäytöksen.

Tämän seurauksena beach volleyn imago on yhä parempi.

## SÄÄNTÖTEKSTI

Tämä teksti on suunnattu laajalle beach volley -yleisölle – pelaajille, valmentajille, tuomareille, katsojille, selostajille ja muille. Sääntöjen ymmärtäminen mahdollistaa paremman pelin ja henkilökohtaisen tyydytyksen: valmentajat voivat luoda parempaa joukkuerakennetta ja taktiikkaa, antaen pelaajille täydet valtuudet näyttää taitojaan. Lisäksi ymmärrys kirjoitettujen sääntöjen ja kentällä tapahtuvien todellisten toimien välisestä suhteesta mahdollistaa toimitsijoiden paremmat päätökset.

Beach volley on sekä virkistys- että kilpailutoimintaa. Virkistysurheilu ammentaa inhimillisestä hengestä ja edistää "hauskuutta" ja terveellistä elämää. Kilpailu antaa ihmisten näyttää parasta kyvykkyyttään, luovuuttaan, ilmaisunvapauttaan ja taisteluhenkeään. Säännöt on suunniteltu ja rakennettu sallimaan kaikkien näiden puolien kukoistaa.

Tämä johdanto on aluksi keskittynyt beach volleyhin kilpailuurheiluna, ennen kuin se pyrkii tunnistamaan menestyksekkään tuomaritoiminnan pääominaisuudet.

## TUOMARI TÄSSÄ VIITEKEHYKSESSÄ

Hyvän toimitsijan ydin on oikeudenmukaisuuden ja johdonmukaisuuden käsitteessä:

Sijoittuminen molempien pelikenttäpuoliskojen väliin on tasapainon symboli, joka rohkaisee pelaajia luottamaan tuomarin toimiin. Tuomarin on kuitenkin oltava pikemminkin mahdollistaja kuin kontrolloija, orkesterinjohtaja pikemminkin kuin diktaattori, tehokas edistäjä pikemminkin kuin "tehokas" rankaisija.

Ymmärtämällä syyn, miksi sääntö on kirjoitettu, ja olemalla selkeä sen tarkoituksesta "shown" viitekehyksessä, tuomarista tulee suuri osa kokonaisvaltaista onnistunutta tuotantoa, samalla kun hän pysyy suurelta osin taka-alalla ja puuttuu peliin vain tarvittaessa. Voimme sanoa, että hyvä tuomari käyttää sääntöjä tehdäkseen kilpailusta täyttävän kokemuksen kaikille asianosaisille.

Niille, jotka ovat lukeneet tähän asti: katsokaa seuraavia sääntöjä hienon pelin nykyisenä kehitystasona, mutta pitäkää mielessä, miksi nämä edeltävät muutamat kappaleet voivat olla yhtä tärkeitä teille omassa asemassanne lajin parissa. Joten...
...
[subrule,number="4.2",title="JOUKKUEEN SIJAINTI"]
====

  Joukkueen alueiden (sisältäen kaksi tuolia kullekin) on oltava 5 metrin päässä sivurajasta, eikä lähempänä kuin 3 metriä kirjurin pöydästä.

====

[subrule,number="4.3",title="VARUSTEET"]
====
...
[subrule,number="4.4",title="VARUSTEIDEN VAIHTAMINEN"]
====

  Jos molemmat joukkueet saapuvat otteluun samanvärisissä paidoissa, suoritetaan arvonta sen määräämiseksi, kumpi joukkue vaihtaa.
...
4.5.3 Kompressiosuojia (pehmustettuja vammansuojia) saa käyttää suojana tai tukena.
  ...
  FIVB:n, maailmanlaajuisissa ja virallisissa aikuisten kilpailuissa näiden suojien tai näkyvien alusvaatteiden on oltava samanvärisiä kuin osa peliasusta.

  Mustaa, valkoista tai neutraaleja värejä saa myös käyttää, edellyttäen että kaikki niitä käyttävät pelaajat käyttävät samaa väriä.

====

[rule,number="5",title="JOUKKUEEN JOHTAJAT"]
====

  Joukkueen kapteeni vastaa joukkueen käytöksestä ja kurista.
...
5.1.2.2 pyytääkseen lupaa:
  ...
  a) vaihtaa asua/varusteita,
  b) tarkistaa numeroita,
...
[rule,number="6",title="PISTEEN SAAMINEN, ERÄN JA OTTELUN VOITTAMINEN"]
====
...
[subrule,number="6.2",title="ERÄN VOITTAMINEN"]
====
...
[subrule,number="6.3",title="OTTELUN VOITTAMINEN"]
====
...
6.4.3 Joukkue, joka todetaan VAJAAKSI erässä tai koko ottelussa menettää vastaavasti erän tai koko ottelun. Vastapuolelle annetaan erän tai ottelun voittoon tarvittavat pisteet, tai pisteet ja erät. Vajaaksi jäänyt joukkue säilyttää pisteensä ja eränsä.
  ...
  {.refs data-refs="7.3.1"}

====

[rule,number="7",title="PELIN RAKENNE"]
====

====

[subrule,number="7.1",title="ARVONTA"]
====
...
[subrule,number="7.2",title="LÄMMITTELY ENNEN OTTELUA"]
====
...
[subrule,number="7.4",title="SIJOITTUMISET"]
====
...
[rule,number="8",title="PELIN TILANTEET"]
====

====

[subrule,number="8.1",title="PALLO PELISSÄ"]
====

  Pallo on pelissä aloitussyötön suoritushetkestä lähtien, kun päätuomari on antanut siihen luvan.
  {.refs data-refs="12,12.3"}

====

[subrule,number="8.2",title="EI PELISSÄ OLEVA PALLO"]
====
...
8.4.3 koskettaa antenneja, köysiä, pylväitä tai verkkoa itseään sivunauhojen ulkopuolella;
  ...
  {.refs data-refs="2.3,D3,D4a"}", "D10 (4)")
...
9.3.4 KAKSOISKOSKETUS: Pelaaja lyö palloa kaksi kertaa peräkkäin tai pallo koskettaa eri kehon osia peräkkäin.
  ...
  {.refs data-refs="9.1.1,9.2.2.2"}")

====

[rule,number="10",title="PALLO VERKOLLA"]
====

====

[subrule,number="10.1",title="PALLO YLITTÄÄ VERKON"]
====
...
10.1.3 Pallo on "ulkona", kun se ylittää verkon kokonaan alapuolitse.
  ...
  {.refs data-refs="10.1.3,11.2.1"}

====

[subrule,number="10.2",title="PALLO KOSKETTAA VERKKOA"]
====
...
[rule,number="11",title="PELAAJA VERKOLLA"]
====

====

[subrule,number="11.1",title="VERKON YLI KUROTTAUTUMINEN"]
====
...
[subrule,number="11.2",title="TUNKEUTUMINEN VASTUSTAJAN TILAAN, KENTÄLLE JA/TAI VAPAA-ALUEELLE"]
====
...
[subrule,number="11.4",title="PELAAJAN VIRHEET VERKOLLA"]
====
...
[rule,number="12",title="ALOITUSSYÖTTÖ"]
====
...
12.2.2.1 kun aloitussyötön suorittanut joukkue voittaa pallorallin, sama pelaaja syöttää uudelleen.
  ...
  {.refs data-refs="7.6.2"}

====

[subrule,number="12.3",title="ALOITUSSYÖTTÖLUVAN ANTAMINEN"]
====
...
[subrule,number="12.4",title="ALOITUSSYÖTÖN SUORITTAMINEN"]
====
...
[subrule,number="12.5",title="PEITTÄMINEN"]
====
...
[rule,number="13",title="HYÖKKÄYSLYÖNTI"]
====
...
[rule,number="14",title="TORJUNTA"]
====

====

[subrule,number="14.1",title="TORJUMINEN"]
====
...
[subrule,number="14.2",title="TORJUNTAKOSKETUS"]
====
  ...
  {.refs data-refs="9.1.1,9.2.2.3"}

====

[subrule,number="14.3",title="TORJUNTA VASTUSTAJAN TILASSA"]
====
  ...
  {.refs data-refs="13.1.1"}

====

[subrule,number="14.4",title="TORJUNTA JA JOUKKUEEN LYÖNNIT"]
====
...
[subrule,number="14.5",title="ALOITUKSEN TORJUMINEN"]
====
...
[subrule,number="15.1",title="SÄÄNTÖMÄÄRÄISTEN PELIKATKOJEN MÄÄRÄ"]
====
...
[subrule,number="15.3",title="SÄÄNTÖMÄÄRÄISTEN PELIKATKOJEN PYYTÄMINEN"]
====
...
15.4.4 Kaikkien sääntömääräisten katkojen (mukaan lukien tekniset aikalisät) ja erätaukojen aikana pelaajien on mentävä heille osoitetulle pelaaja-alueelle.
  ...
  {.refs data-refs="15.5,16.1"}

====

[subrule,number="15.5",title="VIRHEELLISET PYYNNÖT"]
====
...
[rule,number="16",title="PELIN VIIVYTTÄMINEN"]
====

====

[subrule,number="16.1",title="VIIVYTYSTYYPIT"]
====
...
[rule,number="17",title="PELIN POIKKEUKSELLISET KESKEYTYKSET"]
====
...
[subrule,number="17.2",title="ULKOPUOLINEN HÄIRIÖ"]
====
...
[rule,number="18",title="ERÄTAUOT JA PUOLTENVAIHTO"]
====
...
# LUKU 6: OSANOTTAJIEN KÄYTTÄYTYMINEN

[rule,number="19",title="KÄYTTÄYTYMISVAATIMUKSET"]
====
...
[rule,number="20",title="KÄYTTÄYTYMISRIKKEET JA NIIDEN RANKAISEMINEN"]
====

====

[subrule,number="20.1",title="LIEVÄT RIKKEET"]
====

  Lievistä rikkeistä ei tuomita rangaistusta. Päätuomarin velvollisuus on estää joukkueita saavuttamasta rangaistuskynnystä.
  {.refs data-refs="5.1.2,21.3"}

  Tämä tehdään kahdessa vaiheessa:
  Vaihe 1: antamalla suullinen huomautus kapteenin kautta;
  Vaihe 2: näyttämällä KELTAISTA KORTTIA joukkueen jäsenelle. Tämä virallinen varoitus ei itsessään ole rangaistus, vaan merkki siitä, että joukkueen jäsen (ja sitä kautta joukkue) on saavuttanut ottelun rangaistuskynnyksen. Se merkitään pöytäkirjaan, mutta sillä ei ole välittömiä seurauksia.
  {.refs data-refs=""}")

====

[subrule,number="20.2",title="RANGAISTAVAT KÄYTTÄYTYMISRIKKEET"]
====
...
[subrule,number="20.3",title="RANGAISTUSASTEIKKO"]
====
...
20.3.3 Ottelusta poistaminen
  ...
  Ensimmäinen fyysinen hyökkäys tai vihjailtu tai uhattu väkivalta rangaistaan ottelusta poistamisella. Pelaajan on poistuttava pelialueelta ja hänen joukkueensa julistetaan vajaaksi ottelun ajaksi.
  {.refs data-refs="6.4.3,7.3.1"}")

  KÄYTTÄYTYMISRIKKEET rangaistaan rangaistusasteikon mukaisesti.
  {.refs data-refs="D7a"}

====

[subrule,number="20.4",title="KÄYTTÄYTYMISRIKKEET ENNEN ERÄÄ TAI ERIEN VÄLILLÄ"]
====

  Mikä tahansa ennen erää tai erien välillä tapahtuva käyttäytymisrike rangaistaan rangaistusasteikon mukaisesti ja rangaistus sovelletaan seuraavassa erässä.
  {.refs data-refs="D7a"}

====

[subrule,number="20.5",title="YHTEENVETO KÄYTTÄYTYMISRIKKEISTÄ JA KORTEISTA"]
====

  {.refs data-refs=""}")
  Varoitus: ei rangaistusta - Vaihe 1: suullinen huomautus
                            Vaihe 2: symboli Keltainen kortti
  {.refs data-refs="20.1"}

  Rangaistus: seuraamus - symboli Punainen kortti
  {.refs data-refs="20.3.1,D7a"}

  Erästä poistaminen: seuraamus - symboli Punainen + Keltainen kortti yhdessä
  {.refs data-refs="20.3.2,D7a"}

  Ottelusta poistaminen: seuraamus - symboli Punainen + Keltainen kortti erillään
  {.refs data-refs="20.3.3,D7a"}

====

# OSA 2 - JAKSO 2: TUOMARIT

# OSA 2 - JAKSO 2: TUOMARIT

# LUKU 7: TUOMARIT

[rule,number="21",title="TUOMARISTO JA MENETTELYT"]
====

====

[subrule,number="21.1",title="KOKOONPANO"]
====

  Ottelun tuomaristoon kuuluvat seuraavat toimitsijat:
  - päätuomari
  {.refs data-refs="22"}
  - verkkotuomari
  {.refs data-refs="23"}
  - haastetuomari (jos käytössä)
  {.refs data-refs="24"}
  - varalla oleva tuomari (jos käytössä)
  {.refs data-refs="25"}
  - kirjuri
  {.refs data-refs="26"}
  ...
  Heidän sijaintinsa on esitetty Kaaviossa 8.

  FIVB:n, maailmanlaajuisissa ja virallisissa kilpailuissa avustava kirjuri on pakollinen.
  {.refs data-refs="27"}
...
21.2.3.1 Jos virheen vihelsi päätuomari, hän näyttää järjestyksessä:
  ...
  a) joukkueen, joka saa seuraavan aloituksen,
  {.refs data-refs=""}")
  b) virheen luonteen,
...
21.2.3.2 Jos virheen vihelsi verkkotuomari, hän näyttää:
  ...
  a) virheen luonteen,
  b) virheen tehneen pelaajan (tarvittaessa),
...
21.2.3.3 Kaksoisvirheen sattuessa molemmat tuomarit näyttävät järjestyksessä:
  ...
  {.refs data-refs=""}")
  a) virheen luonteen,
  b) virheen tehneet pelaajat (tarvittaessa).
  Seuraavan aloituksen suorittava joukkue osoitetaan sitten päätuomarin toimesta.
  {.refs data-refs=""}")

====

[rule,number="22",title="PÄÄTUOMARI"]
====

====

[subrule,number="22.1",title="SIJAINTI"]
====

  Päätuomari suorittaa tehtävänsä seisten tuomaritelineellä, joka on sijoitettu verkon toiseen päähän vastapäätä kirjuria. Hänen katseensa tason on oltava noin 50 cm verkon yläpuolella.
  {.refs data-refs="D1,D8"}
...
22.3.2.3 päättämään:
  ...
  a) syöttäjän virheistä ja syöttävän joukkueen peittämisestä;
  {.refs data-refs="D5"}
  b) virheistä pallon pelaamisessa;
  c) virheistä verkon yläpuolella ja pelaajan virheellisestä kosketuksesta verkkoon, ensisijaisesti (mutta ei yksinomaan) hyökkääjän puolella;
...
[rule,number="23",title="VERKKOTUOMARI"]
====

====

[subrule,number="23.1",title="SIJAINTI"]
====

  Verkkotuomari suorittaa tehtävänsä seisten pelikentän ulkopuolella lähellä pylvästä, vastakkaisella puolella kuin päätuomari ja kasvot häneen päin.
  {.refs data-refs="D1,D8"}
...
[rule,number="24",title="HAASTETUOMARI"]
====

  FIVB:n, maailmanlaajuisissa ja virallisissa kilpailuissa, jos Video Challenge System (VCS) on käytössä, haastetuomari on pakollinen.

====

[subrule,number="24.1",title="SIJAINTI"]
====

  Haastetuomari suorittaa tehtävänsä haastkopissa, joka sijaitsee erillisessä paikassa FIVB:n teknisen delegaatin määrittämänä.
...
[rule,number="25",title="VARALLA OLEVA TUOMARI"]
====

  FIVB:n, maailmanlaajuisissa ja virallisissa kilpailuissa varalla oleva tuomari on pakollinen kaikissa TV-otteluissa ja aina, kun Video Challenge System (VCS) on käytössä.

====

[subrule,number="25.1",title="SIJAINTI"]
====

  Varalla oleva tuomari suorittaa tehtävänsä sijaiten erillisessä paikassa FIVB:n kenttäjärjestelyjen mukaisesti.

====

[subrule,number="25.2",title="TEHTÄVÄT"]
====
...
[rule,number="26",title="KIRJURI"]
====

====

[subrule,number="26.1",title="SIJAINTI"]
====

  Kirjuri suorittaa tehtävänsä istuen kirjuripöydän ääressä, vastakkaisella puolella kenttää päätuomariin nähden ja kasvot häneen päin.
  {.refs data-refs="D1,D8"}

====

[subrule,number="26.2",title="TEHTÄVÄT"]
====
...
[rule,number="27",title="AVUSTAVA KIRJURI"]
====

====

[subrule,number="27.1",title="SIJAINTI"]
====

  {.refs data-refs="D1,D8"}
  Avustava kirjuri suorittaa tehtävänsä istuen kirjurin vieressä kirjuripöydän ääressä.

====

[subrule,number="27.2",title="TEHTÄVÄT"]
====
...
[rule,number="28",title="RAJATUOMARIT"]
====

====

[subrule,number="28.1",title="SIJAINTI"]
====

  Jos käytetään vain kahta rajatuomaria, he seisovat kentän kulmissa lähimpänä kummankin tuomarin oikeaa kättä, viistosti 1-2 metrin päässä kulmasta.
  {.refs data-refs="D1,D8"}
  Kumpikin heistä valvoo sekä pääty- että sivurajaa omalla puolellaan.

  FIVB:n, maailmanlaajuisissa ja virallisissa kilpailuissa, jos käytetään neljää rajatuomaria, he seisovat vapaa-alueella 1-3 metrin päässä kentän kustakin kulmasta, valvottamansa rajan kuvitteellisella jatkeella.
...
[rule,number="29",title="VIRALLISET KÄSIMERKIT"]
====

====

[subrule,number="29.1",title="TUOMARIEN KÄSIMERKIT"]
====

  Tuomarit näyttävät virallisella käsimerkillä vihellyksensä syyn (vihelletyn virheen luonteen tai myönnetyn katkon tarkoituksen). Merkin on oltava näkyvissä hetken aikaa ja, jos se näytetään yhdellä kädellä, käden on vastattava sen joukkueen puolta, joka on tehnyt virheen tai pyynnön.
  {.refs data-refs="D9"}

====

[subrule,number="29.2",title="RAJATUOMARIEN LIPPUMERKIT"]
====

  Rajatuomarien onytettävä virallisella lippumerkillä tuomitun virheen luonne ja pidettävä merkkiä näkyvissä hetken aikaa.
  {.refs data-refs="D10"}
...
#rule("PROTOKOLLA", "")[
  Tapahtumasarja ennen ottelun alkua, sisältäen arvonnan, lämmittelyn, joukkueiden ja tuomareiden esittelyn, kuten on kuvattu erillisessä kilpailukäsikirjassa.
]

#rule("KILPAILU-/VALVONTA-ALUE", "")[
  Kilpailu-/valvonta-alue on pelikenttää ja vapaa-aluetta ympäröivä käytävä, joka sisältää kaikki tilat ulompiin aitoihin tai raja-aitoihin asti. Katso kaavio/kuva 1a.
]

#rule("ALUEET (ZONES)", "")[
  Nämä ovat pelialueen (eli pelikentän ja vapaa-alueen) osia, jotka on määritelty tiettyä tarkoitusta varten (tai joilla on erityisiä rajoituksia) sääntötekstissä. Näitä ovat: Aloitusalue ja Vapaa-alue.
]

#rule("ALAPUOLINEN TILA", "")[
  Tämä on tila, jonka yläosan määrittelevät verkon alareuna ja sen pylväisiin yhdistävä naru, sivuilta pylväät ja alhaalta pelialusta.
]

#rule("YLITYSKAISTA", "")[
  Ylityskaistan määrittelevät:
  - Verkon yläreunan vaakasuora nauha
  - Antennit ja niiden jatkeet
  - Katto

  Pallon on ylitettävä verkko vastustajan KENTÄLLE ylityskaistan kautta.
]

#rule("ULKOPUOLINEN TILA", "")[
  Ulkopuolinen tila on verkon pystytasossa ylityskaistan ja alapuolisen tilan ulkopuolella oleva tila.
]

#rule("FIVB:N SOPIMUKSESTA", "")[
  Tämä lausuma tunnustaa, että vaikka varusteiden ja tilojen standardeista ja teknisistä tiedoista on olemassa säännökset, on tilanteita, joissa FIVB voi tehdä erityisjärjestelyjä Beach Volleyn edistämiseksi tai uusien olosuhteiden testaamiseksi.
]

#rule("FIVB:N STANDARDIT", "")[
  FIVB:n välinevalmistajille määrittelemät tekniset tiedot tai rajat.
]

#rule("VIRHE", "")[
  a) Sääntöjen vastainen pelisuoritus.
  b) Muu sääntörikkomus kuin pelisuoritus.
]

#rule("JOUKKUEEN ENSIMMÄINEN LYÖNTI", "")[
  On kolme tapausta, joissa pelisuoritus katsotaan joukkueen ensimmäiseksi lyönniksi:
  - Aloituksen vastaanotto
  - Vastustajan hyökkäyksen vastaanotto
  - Vastustajan torjunnasta kimpoavan pallon pelaaminen
]

#rule("RALLIPISTEJÄRJESTELMÄ", "")[
  Tämä on pistelaskujärjestelmä, jossa piste saadaan aina, kun palloralli voitetaan.
]

#rule("TEKNINEN AIKALISÄ", "")[
  Tämä erityinen pakollinen aikalisä on normaalien aikalisien lisäksi tarkoitettu Beach Volleyn edistämiseen, pelin analysointiin ja kaupallisten mahdollisuuksien lisäämiseen. Tekniset aikalisät ovat pakollisia FIVB:n, maailmanlaajuisissa ja virallisissa kilpailuissa.
]

#rule("ERÄTAUKO", "")[
  Erien välinen aika. Puoltenvaihtoa kolmannessa (ratkaisevassa) erässä ei pidetä erätaukona.
]

#rule("HÄIRINTÄ", "")[
  Mikä tahansa toiminta, joka luo edun vastustajaa vastaan tai estää vastustajaa pelaamasta palloa.
]

#rule("ULKOPUOLINEN ESINE", "")[
  Esine tai henkilö, joka ollessaan pelikentän ulkopuolella tai vapaan pelitilan rajan lähellä muodostaa esteen pallon lentoradalle. Esimerkiksi: Kattovalot, tuomarin tuoli, TV-kalusto, kirjuripöytä ja verkkopylväät. Ulkopuoliset esineet eivät sisällä antenneja, koska ne katsotaan osaksi verkkoa.
]

#rule("PALLONPALAUTTAJAT", "")[
  Nämä ovat henkilöitä, joiden tehtävänä on ylläpitää pelin sujuvuutta vierittämällä pallo syöttäjälle pallorallien välillä.
]

#rule("HIEKAN TASOITTAJAT", "")[
  Nämä kenttäavustajat käyttävät pitkiä haravia tai tasapäisiä tankoja hiekan tasoittamiseen erityisesti kentän rajojen ympärillä ja kentän keskiakselilla pylväiden välissä.
]
